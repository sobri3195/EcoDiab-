...
export default function AppShell({ children }: { children: ReactNode }) {
  const { lang, setLang, role, setRole, darkMode, toggleDarkMode } = useAppContext();
        ...
        <div className="flex-1">
          <header className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-900">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={toggleDarkMode} className="rounded-md border border-slate-300 p-2 dark:border-slate-700" aria-label="Toggle dark mode">
